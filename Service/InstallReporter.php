<?php
/**
 * Standalone install + heartbeat reporter for Panth_LiveActivity.
 *
...
namespace Panth\LiveActivity\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_LiveActivity';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-live-activity';
